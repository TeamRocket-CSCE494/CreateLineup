...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const CreateLineupPage(title: 'Create Lineup'),
    );
  }
}

class CreateLineupPage extends StatefulWidget {
  const CreateLineupPage({Key? key, required this.title}) : super(key: key);
...
class _CreateLineupPageState extends State<CreateLineupPage> {
  String teamname = "Test"; // change once we get team names from API
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        // Here we take the value from the CreateLineupPage object that was created by
